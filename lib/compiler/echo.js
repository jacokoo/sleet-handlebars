...
var _inlineTag = require('./inline-tag');
...
var EchoCompiler = exports.EchoCompiler = function (_InlineTagCompiler) {
    _inherits(EchoCompiler, _InlineTagCompiler);
                ...
                return item.attributes.map(function (a) {
                    return a.value.map(function (v) {
                        if (v.minor === 'identifier') {
                            return '' + _this2.TOKEN_OPEN_START + v.value + _this2.TOKEN_OPEN_END;
                        }
                        return v.value;
                    }).join('');
                }).join('');
