...
exports.HelperValueCompiler = undefined;
...
var HelperValueCompiler = exports.HelperValueCompiler = function (_ValueCompiler) {
    _inherits(HelperValueCompiler, _ValueCompiler);

    function HelperValueCompiler(argumentCount) {
        _classCallCheck(this, HelperValueCompiler);

        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(HelperValueCompiler).call(this));

        _this._arugmentCount = argumentCount;
        return _this;
    }

    _createClass(HelperValueCompiler, [{
        key: 'compile',
        value: function compile(context, value, attribute, group, tag) {
            console.log(value.type, value.major, value.minor);
